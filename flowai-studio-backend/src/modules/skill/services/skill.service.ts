...
export class SkillService {
  ...
  listCodeFiles(params: Record<string, any>) {
    return executeBuiltinSkill('code_list', params);
  }

  readCodeFile(params: Record<string, any>) {
    return executeBuiltinSkill('code_read', params);
  }

  searchCode(params: Record<string, any>) {
    return executeBuiltinSkill('code_search', params);
  }
