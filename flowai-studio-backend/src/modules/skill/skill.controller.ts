...
export class SkillController {
  ...
  @Post('code/list')
  listCodeFiles(@Body() params: Record<string, any>) {
    return this.skillService.listCodeFiles(params);
  }

  @Post('code/read')
  readCodeFile(@Body() params: Record<string, any>) {
    return this.skillService.readCodeFile(params);
  }

  @Post('code/search')
  searchCode(@Body() params: Record<string, any>) {
    return this.skillService.searchCode(params);
  }
